<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation">
      ...
      ?></li>
    <li role="presentation">
      <?php echo $this->Html->link( 'ประเภทพัสดุ', array('controller'=>'ProdCatalogs',
      'action' => 'view' )); ?>
    </li>
    <li role="presentation" class="active">
      <?php echo $this->Html->link( 'สร้างประเภทพัสดุ', array('controller'=>'ProdCatalogs',
      'action' => 'add' )); ?>
    </li>
  </ul>
</div>
...
<H2><?php echo __('เพิ่มประเภทพัสดุ');?></H2>
<br>
